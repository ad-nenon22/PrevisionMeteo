...
<section class="gallery">
 ...
 <section class="educational-content">
    ...
    <div class="articles">
        <article>
            <div class="icon"><img src="images/anticyclone1.png" alt="Anticyclone"></div>
            <h3>Qu'est-ce qu'un anticyclone ?</h3>
            <p>Découvrez comment les anticyclones façonnent notre météo au quotidien, en apportant calme et ciel dégagé.</p>
            <a href="actualite.php">Lire plus</a>
        </article>
        <article>
            <div class="icon"><img src="images/orage.png" alt="Orage"></div>
            <h3>Les orages : comment se forment-ils ?</h3>
            <p>Un phénomène fascinant qui résulte d’une combinaison unique de facteurs.</p>
            <a href="actualite.php">Lire plus</a>
        </article>
        <article>
            <div class="icon"><img src="images/neige.png" alt="Tempête de neige"></div>
        ...
        <article>
            <div class="icon"><img src="images/canicule.png" alt="Tempête de neige"></div>
            <h3>Canicule</h3>
            <p>Découvrez pourquoi certaines régions sont plus sujettes aux canicules plus que d'autres.</p>
            <a href="actualite.php">Lire plus</a>
        </article>
    </div>
</section>
